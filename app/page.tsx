...
export const metadata: Metadata = {
  ...
  description: 'Bathtub reglazing costs $300–$600 — up to 90% less than replacement. JLS Reglazing has refinished 4,000+ tubs, sinks, and countertops across San Bernardino, Riverside, and Los Angeles counties. 20+ years experience. 3-year warranty. Free quotes.',
