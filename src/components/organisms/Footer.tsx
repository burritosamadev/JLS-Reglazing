        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <Link href="/" className="inline-block mb-4">
              <img src="/logo-light.svg" alt="JLS Reglazing" className="h-12 w-auto" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.path}>
                  <Link href={link.path} className="text-gray-400 hover:text-cta transition-colors">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {serviceAreas.map((area) => (
                <li key={area.path}>
                  <Link href={area.path} className="text-gray-400 hover:text-cta transition-colors">
                    {area.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-400">
              <a href="mailto:jorge@jlsreglazing.com" className="flex items-center gap-2 hover:text-cta transition-colors">
              ...
              <div className="flex gap-4 mt-4">
                <a href="https://www.facebook.com/profile.php?id=61586186871010" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#1877F2] transition-colors" aria-label="Facebook">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
              </div>

              <div className="mt-4">
                <Link href="/contact" className="inline-block bg-cta hover:bg-cta-hover text-white px-5 py-2 rounded-lg font-jost font-semibold text-sm transition-colors">
                  Get Free Quote
                </Link>
              </div>
            </div>
