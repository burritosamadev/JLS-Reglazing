...
export default function TopBar() {
  return (
    <div className="bg-[#221F1C] text-gray-100 h-10 border-b border-[#E5E0D6]/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
        <div className="flex items-center justify-between h-full">
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <a
              href="https://instagram.com/jlsreglazing"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-100 hover:text-[#FB8040] transition-colors transform hover:scale-110 duration-200"
            ...
            <a
              href="https://tiktok.com/@jlsreglazing"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-100 hover:text-[#FB8040] transition-colors transform hover:scale-110 duration-200"
              aria-label="TikTok"
            ...
            <a
              ...
              onClick={() => analytics.emailClick('TopBar')}
              className="text-gray-100 hover:text-[#FB8040] transition-colors transform hover:scale-110 duration-200"
              aria-label="Email"
            >
