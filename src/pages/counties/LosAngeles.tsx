    ...
    <div>
      ...
      <section className="bg-[#232423] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="hero-title mb-6">Bathtub Reglazing in Los Angeles County</h1>
            <p className="text-xl text-gray-100 max-w-3xl mx-auto font-jost">
              Professional bathtub and kitchen reglazing services throughout Los Angeles County
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="section-title text-[#232423] mb-6">
              ...
              <p className="text-lg text-gray-700 font-jost mb-6 leading-relaxed">
                Our team specializes in multi-unit properties, commercial buildings, and residential
                homes. We understand the fast-paced nature of LA property management and deliver
            ...
            <div>
              <div className="bg-[#FB8040] text-white rounded-xl p-8 mb-6">
                <h3 className="text-2xl font-orbitron font-bold mb-4">
                  LA County Property Managers Save Big
                </h3>
                <p className="text-lg mb-6 font-jost">
                  Save up to <span className="font-bold text-white text-xl">90%</span> vs replacement. Volume discounts available for multi-unit properties!
                </p>
                <Link
                  to="/contact"
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                <h3 className="text-xl font-orbitron font-semibold text-[#232423] mb-4">
                  Trusted by LA County
                </h3>
                <ul className="space-y-3">
                  {[
                    '20+ years in LA County',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="section-title text-[#232423] mb-4">
              Los Angeles County Areas We Serve
            </h2>
          </div>
      ...
      <section className="py-20 bg-[#232423] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="section-title mb-6">Los Angeles County's Reglazing Experts</h2>
          <p className="text-xl mb-8 font-jost">
            Professional service for residential and commercial properties. Get your free quote
            today.
          </p>
          <Link
            to="/contact"
