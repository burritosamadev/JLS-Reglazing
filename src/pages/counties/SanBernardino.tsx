...
export default function SanBernardino() {
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-[#232423] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="hero-title mb-6">Bathtub Reglazing in San Bernardino County</h1>
            <p className="text-xl text-gray-100 max-w-3xl mx-auto font-jost">
              Professional bathtub, kitchen, and tile reglazing services throughout San Bernardino
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-gray-700 font-jost mb-6 leading-relaxed">
                Our locally-based team understands the unique needs of San Bernardino County
                properties, from older homes requiring restoration to modern apartments needing
                quick turnaround for tenant turnover.
              </p>
            ...
            <div>
              <div className="bg-[#FB8040] text-white rounded-xl p-8 mb-6">
                ...
                <p className="text-lg mb-6 font-jost">
                  Save up to <span className="font-bold text-white text-xl">90%</span> compared to replacement costs. Get a free quote today!
                </p>
                <Link
                  to="/contact"
      ...
      <section className="py-20 bg-[#232423] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="section-title mb-6">
            Ready to Transform Your San Bernardino County Property?
          </h2>
          <p className="text-xl mb-8 font-jost">
            Contact us today for expert bathtub and kitchen reglazing services.
          </p>
          <Link
            to="/contact"
